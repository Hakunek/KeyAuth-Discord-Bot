...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) => subcommand.setName("licenses").setDescription("Fetch All Licenses"))
        .addSubcommand((subcommand) => subcommand.setName("users").setDescription("Fetch All Users"))
        .addSubcommand((subcommand) => subcommand.setName("subs").setDescription("Fetch All Subs"))
        .addSubcommand((subcommand) => subcommand.setName("chats").setDescription("Fetch All Chats"))
        .addSubcommand((subcommand) => subcommand.setName("sessions").setDescription("Fetch All Sessions"))
        .addSubcommand((subcommand) => subcommand.setName("files").setDescription("Fetch All Files"))
        .addSubcommand((subcommand) => subcommand.setName("vars").setDescription("Fetch All Vars"))
        .addSubcommand((subcommand) => subcommand.setName("blacklists").setDescription("Fetch All Blacklists"))
        .addSubcommand((subcommand) => subcommand.setName("webhooks").setDescription("Fetch All Webhooks"))
        .addSubcommand((subcommand) => subcommand.setName("buttons").setDescription("Fetch All Buttons")),
